        ...
        on_exit = function(_, code)
            if code == 0 then
                vim.schedule(function()
                    ...
                    pcall(function() vim.cmd("JdtUpdateConfig") end)
                    pcall(function() vim.cmd("JdtRestart") end)
                end)
            else
                vim.schedule(function()
    ...
    return {
        ...
        init_options = {
            bundles = (function()
                ...
                local java_test = vim.fn.glob(mason_packages .. "/java-test/extension/server/*.jar", true, true)
